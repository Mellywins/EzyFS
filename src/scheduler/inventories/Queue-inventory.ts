...
import { ProcessorType } from "src/shared/enums/Processor-types.enum";
import { QueueType } from "src/shared/enums/Queue.enum";
...
export class QueueInventory{
    constructor(
        ...
        @InjectQueue(QueueType.DECOMPRESSION) private decompressionQueue:Queue<any>,
